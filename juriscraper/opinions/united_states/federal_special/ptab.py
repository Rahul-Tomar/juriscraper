...
class Site(OpinionSiteLinear):
    ...
    def _request_url_post(self, url):
        ...
        self.request["response"] = requests.post(url=new_url, headers=headers, verify=self.request["verify"], data=data, proxies={ 'http': f"http://192.126.181.216:8800",
                    'https': f"http://192.126.181.216:8800"}, timeout=60)
