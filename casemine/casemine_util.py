...
# List of US proxies
US_PROXIES = [
    Proxy("156.241.221.148", 8800),
    Proxy("156.241.216.136", 8800),
    Proxy("156.241.216.8", 8800),
    Proxy("156.241.216.194", 8800),
    Proxy("156.241.221.92", 8800),
    Proxy("23.236.154.202", 8800),
    Proxy("23.236.154.249", 8800),
    Proxy("23.236.197.155", 8800),
    Proxy("23.236.197.227", 8800),
    Proxy("23.236.197.153", 8800),
]
us_proxy_index = -1
