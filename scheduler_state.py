...
# Configure logging
logging.basicConfig(level=logging.INFO, format='%(asctime)s - %(name)s - %(levelname)s - %(message)s', handlers=[logging.FileHandler("bankruptcy_scheduler.log"), logging.StreamHandler()])
...
RESTRICTED_CLASSES = {
    "alacivapp", "alacrimapp", "calag", "haw_beginningofyear", "hawapp_beginningofyear", "ind", "indctapp", "indtc", "mdag", "miss", "miss_beginningofyear", "missctapp",
    "missctapp_beginningofyear", "minnag", "nytrial", "nyag", "sc", "scctapp"
}
