...
RESTRICTED_CLASSES = { # Temporary classes
    "Practice1","ariz_2","arizctapp_div_1","ark_ag","fla_new","lactapp_new","okla","okla_new","oklaag","oklacivapp","oklacrimapp","coloctapp_u","mo", "mo_min_or_sc", "moctapp_eastern", "moctapp_western","tex"
    # permanent classes
...
def setup_logging():
    ...
    log_filename = os.path.join(log_dir, f"state_{today}.log")
